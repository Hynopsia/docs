...
| Commuting cost | Routine commuting, local transport, or explicit repositioning costs such as jumpseat fares. |
...
Older ledger history may still show previous away-from-base wording, but new return-to-base completions should not add a hotel or overnight stay charge.
