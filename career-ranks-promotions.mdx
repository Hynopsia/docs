...
| Captain | Moves into the Captain pay band, which is higher than the First Officer band, and unlocks Historical Operations when the employer has an archive. |
