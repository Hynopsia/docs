...
Career fatigue uses real tracked flight time, recent Career activity, real-world rest, and sim-rate usage. The fatigue penalty is capped at 4 points and only affects Career scoring. More than 20 Career flights inside 48 hours still acts as an anti-grind fallback.
