...
<CardGroup cols={2}>
  ...
  <Card title="Career Saves" icon="copy-plus" href="/career-saves">
    Manage up to three independent pilots, switch saves, understand paused Career time, and reset or delete a save safely.
  </Card>
  ...
  <Card title="Historical Operations" icon="history" href="/career-historical-operations">
    As a Captain or Senior Captain, dispatch historical flights from your current airline with Manual Bid or Scheduler.
  </Card>
  <Card title="Bid Board" icon="list-ordered" href="/career-bid-board">
    Submit ranked monthly route preferences and understand seniority-based awards.
  </Card>
  <Card title="Reserve" icon="radio-tower" href="/career-reserve">
  ...
  <Card title="Troubleshooting" icon="circle-help" href="/career-troubleshooting">
...
- Career Mode supports up to three separate saves. Each save has its own pilot and progression. See [Career Saves](/career-saves) for the chooser, switching rules, and save management.
...
- Captains and Senior Captains can use Historical Operations when their current airline has an archive. Historical flights go to My Flights independently of the normal Calendar roster.
...
- Resetting a Career save is permanent, but it keeps that save in the same slot and returns it to onboarding. See [Career Saves](/career-saves) and [Career Mode Settings](/settings-career-mode) before resetting.
- Shared tracking and scoring systems still matter in Career. See [Tracking Methods](/tracking-methods) and [Scoring and XP](/scoring-xp) when you need the full explanation.
