...
Career type ratings use a $100,000 base cost unless the offer provides a different value.

The airline may cover all or part of the cost. If the pilot share is required, you must have the money or use an available loan option before accepting the offer.
